...
export default function ConsentsPage() {
  ...
  <div className="flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl border p-6 shadow-sm bg-white">
        ...
        <p className="text-sm text-gray-600 mt-1">Оферта / Данные / Мед. предупреждение</p>
        ...
        <button
          disabled={!can}
          onClick={finish}
          className="mt-5 w-full rounded-xl bg-black text-white py-2 disabled:opacity-50"
        >
          Завершить
        </button>
